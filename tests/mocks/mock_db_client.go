...
// SaveActiveStakingDelegation provides a mock function with given fields: ctx, stakingTxHashHex, stakerPkHex, finalityProviderPkHex, amount, startHeight, timelock, stakingOutputIndex
func (_m *DBClient) SaveActiveStakingDelegation(ctx context.Context, stakingTxHashHex string, stakerPkHex string, finalityProviderPkHex string, amount uint64, startHeight uint64, timelock uint64, stakingOutputIndex uint64) error {
	ret := _m.Called(ctx, stakingTxHashHex, stakerPkHex, finalityProviderPkHex, amount, startHeight, timelock, stakingOutputIndex)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, uint64, uint64, uint64, uint64) error); ok {
		r0 = rf(ctx, stakingTxHashHex, stakerPkHex, finalityProviderPkHex, amount, startHeight, timelock, stakingOutputIndex)
	} else {
		r0 = ret.Error(0)
	}
